...
> Xin chào thầy cô. Em là Nguyễn Tấn Thắng, mã số sinh viên 23127259. Đây là video demo bài HW04 Automation Testing của em. Em sẽ trình bày bằng tiếng Việt theo yêu cầu đề bài. Trên màn hình là kết quả lệnh whoami, hostname và đường dẫn repository để chứng minh môi trường em đang sử dụng. Hệ thống kiểm thử là EShop gồm Backend Node.js, Frontend Web và Frontend Admin.
