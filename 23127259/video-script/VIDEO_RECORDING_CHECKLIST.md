...
- [ ] Có face-cam hoặc hiển thị rõ kết quả `whoami` và `hostname`.
- [ ] Chạy một feature hoàn chỉnh trên Chromium, Firefox và WebKit.
- [ ] Hiển thị bảng summary có `unexpectedFailures: 0`.
- [ ] Mở HTML report có `Run by: 23127259` và ISO timestamp.
- [ ] Giải thích ít nhất một lỗi trong script AI sinh và cách con người sửa.
