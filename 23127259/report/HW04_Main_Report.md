...
- **Skill:** `agent-skill/SKILL.md`; bản giải trình trong `agent-skill/AGENT_SKILL.md`. Tôi đã hoàn thành toàn bộ test case và tự quay, thuyết minh hai video bằng tiếng Việt.
